...
#define retainedInvocation(invocation,target) [NSInvocation retainedInvocationWithTarget:target invocationOut:&invocation]

#define nonRetainedInvocation(invocation,target)[NSInvocation invocationWithTarget:target invocationOut:&invocation]
