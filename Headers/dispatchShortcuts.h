...
static inline void dispatch_async_priority(dispatch_queue_priority_t priority, dispatch_block_t block) {
	dispatch_async(dispatch_get_global_queue(priority,0),block);
}
static inline void dispatch_sync_priority(dispatch_queue_priority_t priority, dispatch_block_t block) {
